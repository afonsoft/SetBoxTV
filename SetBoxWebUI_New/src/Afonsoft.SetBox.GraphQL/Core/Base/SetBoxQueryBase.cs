...
namespace Afonsoft.SetBox.Core.Base
{
    public abstract class SetBoxQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SetBoxQueryBase(string fieldName,
