...
namespace Afonsoft.SetBox.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SetBoxServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.SetBox", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
