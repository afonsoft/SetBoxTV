...
{
    public class StripeGatewayManager : SetBoxServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SetBox";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SetBoxConsts.Currency;
        }
