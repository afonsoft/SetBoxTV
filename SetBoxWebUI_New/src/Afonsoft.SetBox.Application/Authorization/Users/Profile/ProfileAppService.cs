...
using Afonsoft.SetBox.Authentication.TwoFactor.Google;
using Afonsoft.SetBox.Authorization.Users.Dto;
using Afonsoft.SetBox.Authorization.Users.Profile.Cache;
using Afonsoft.SetBox.Authorization.Users.Profile.Dto;
using Afonsoft.SetBox.Friendships;
using Afonsoft.SetBox.Gdpr;
using Afonsoft.SetBox.Identity;
using Afonsoft.SetBox.Net.Sms;
using Afonsoft.SetBox.Security;
using Afonsoft.SetBox.Storage;
using Afonsoft.SetBox.Timing;

namespace Afonsoft.SetBox.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SetBoxAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.SetBox",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.SetBox",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
