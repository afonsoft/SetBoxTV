...
using Afonsoft.SetBox.DemoUiComponents.Dto;

namespace Afonsoft.SetBox.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SetBoxAppServiceBase, IDemoUiComponentsAppService
    {
