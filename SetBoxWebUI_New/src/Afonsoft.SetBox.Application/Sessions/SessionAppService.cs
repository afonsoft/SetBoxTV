...
{
    public class SessionAppService : SetBoxAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = SetBoxConsts.Currency,
                    CurrencySign = SetBoxConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = SetBoxConsts.AllowTenantsToChangeEmailSettings
                }
            };
