...
using Afonsoft.SetBox.Auditing.Exporting;
...
using EntityHistoryHelper = Afonsoft.SetBox.EntityHistory.EntityHistoryHelper;

namespace Afonsoft.SetBox.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SetBoxAppServiceBase, IAuditLogAppService
    {
