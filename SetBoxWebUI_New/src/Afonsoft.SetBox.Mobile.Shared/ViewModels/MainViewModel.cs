...
using MvvmHelpers;
using Afonsoft.SetBox.Authorization.Users.Profile;
...
using Afonsoft.SetBox.Controls;
using Afonsoft.SetBox.Dto;
using Afonsoft.SetBox.Extensions;
using Afonsoft.SetBox.Localization;
using Afonsoft.SetBox.UI;
using Afonsoft.SetBox.UI.Assets;
using Afonsoft.SetBox.Views;
using DependencyResolver = Afonsoft.SetBox.Core.Dependency.DependencyResolver;
...
namespace Afonsoft.SetBox.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SetBox";
