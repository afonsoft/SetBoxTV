...
using Afonsoft.SetBox.MultiTenancy.HostDashboard;
...
namespace Afonsoft.SetBox.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SetBoxDbContext context, SubscriptionPayment subscriptionPayment)
        {
