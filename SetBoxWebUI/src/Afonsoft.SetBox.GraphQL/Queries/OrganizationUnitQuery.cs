...
using Afonsoft.SetBox.Core.Base;
using Afonsoft.SetBox.Core.Extensions;
using Afonsoft.SetBox.Dto;
using Afonsoft.SetBox.Types;

namespace Afonsoft.SetBox.Queries
{
    public class OrganizationUnitQuery : SetBoxQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
