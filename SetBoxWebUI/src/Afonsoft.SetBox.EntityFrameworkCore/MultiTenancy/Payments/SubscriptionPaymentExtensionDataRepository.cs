...
using Afonsoft.SetBox.EntityFrameworkCore.Repositories;

namespace Afonsoft.SetBox.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SetBoxRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SetBoxDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
