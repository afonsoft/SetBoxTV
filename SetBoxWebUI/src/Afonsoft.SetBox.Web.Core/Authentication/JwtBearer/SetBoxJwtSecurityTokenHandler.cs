...
namespace Afonsoft.SetBox.Web.Authentication.JwtBearer
{
    public class SetBoxJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public SetBoxJwtSecurityTokenHandler()
        {
