...
namespace Afonsoft.SetBox.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class SetBoxScriptSrcTagHelper : TagHelper
    {
        ...
        public SetBoxScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
