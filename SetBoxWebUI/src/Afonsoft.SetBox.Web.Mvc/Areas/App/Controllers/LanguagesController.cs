...
using Afonsoft.SetBox.Web.Areas.App.Models.Languages;
...
namespace Afonsoft.SetBox.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : SetBoxControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = SetBoxConsts.LocalizationSourceName;
            }
