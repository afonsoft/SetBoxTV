...
!function(n){if(n.fn.dataTableExt){n.fn.dataTable&&(n.extend(!0,n.fn.dataTable.defaults,{ajax:function(t,a,o){o&&o.oInit&&o.oInit.listAction&&function(t,a,o,e){var i={};if(t.inputFilter&&(i=n.extend(i,t.inputFilter())),e.oInit.paging&&(i=n.extend(i,{maxResultCount:a.length,skipCount:a.start})),a.order&&a.order.length>0){var l=a.order[0];a.columns[l.column].name?i.sorting=a.columns[l.column].name+" "+l.dir:a.columns[l.column].data&&(i.sorting=a.columns[l.column].data+" "+l.dir)}t.ajaxFunction&&t.ajaxFunction(i).done(function(n){var a;e.rawServerResponse=n,a=t.disableResponseHtmlEncoding?n.items:app.htmlUtils.htmlEncodeJson(n.items),o({recordsTotal:n.totalCount,recordsFiltered:n.totalCount,data:a})})}(o.oInit.listAction,t,a,o)}}),n.fn.dataTable.Api.register("ajax.reloadPage()",function(){this.ajax.reload(null,!1)}))}}(jQuery);
!function(a){if(a.fn.dataTable){a.extend(!0,a.fn.dataTable.defaults,{dom:"<'row'<'col-md-6 col-sm-6'l><'col-md-6 col-sm-6'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-7 col-sm-7'p>>",language:{lengthMenu:" _MENU_ records ",paginate:{previous:"Prev",next:"Next",page:"Page",pageOf:"of"}},pagingType:"bootstrap_number"}),a.extend(a.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper",sFilterInput:"form-control form-control-sm",sLengthSelect:"form-control form-control-sm"}),a.fn.dataTable.defaults.renderer="bootstrap",a.fn.dataTable.ext.renderer.pageButton.bootstrap=function(e,i,t,n,l,s){var o,r,g=new a.fn.dataTable.Api(e),d=e.oClasses,p=e.oLanguage.oPaginate,f=function(i,n){var c,b,u,h,P=function(a){a.preventDefault(),"ellipsis"!==a.data.action&&g.page(a.data.action).draw(!1)};for(c=0,b=n.length;c<b;c++)if(h=n[c],a.isArray(h))f(i,h);else{switch(o="",r="",h){case"ellipsis":o="&hellip;",r="disabled";break;case"first":o=p.sFirst,r=h+(l>0?"":" disabled");break;case"previous":o=p.sPrevious,r=h+(l>0?"":" disabled");break;case"next":o=p.sNext,r=h+(l<s-1?"":" disabled");break;case"last":o=p.sLast,r=h+(l<s-1?"":" disabled");break;default:o=h+1,r=l===h?"active":""}o&&(u=a("<li>",{class:d.sPageButton+" "+r,"aria-controls":e.sTableId,tabindex:e.iTabIndex,id:0===t&&"string"==typeof h?e.sTableId+"_"+h:null}).append(a("<a>",{href:"#"}).html(o)).appendTo(i),e.oApi._fnBindAction(u,{action:h},P))}};f(a(i).empty().html('<ul class="pagination"/>').children("ul"),n)},a.fn.dataTableExt.oApi.fnPagingInfo=function(a){return{iStart:a._iDisplayStart,iEnd:a.fnDisplayEnd(),iLength:a._iDisplayLength,iTotal:a.fnRecordsTotal(),iFilteredTotal:a.fnRecordsDisplay(),iPage:-1===a._iDisplayLength?0:Math.ceil(a._iDisplayStart/a._iDisplayLength),iTotalPages:-1===a._iDisplayLength?0:Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength)}},a.extend(a.fn.dataTableExt.oPagination,{bootstrap_full_number:{fnInit:function(e,i,t){var n=e.oLanguage.oPaginate,l=function(a){a.preventDefault(),e.oApi._fnPageChange(e,a.data.action)&&t(e)};a(i).append('<ul class="pagination"><li class="prev disabled"><a href="#" title="'+n.sFirst+'"><i class="fa fa-angle-double-left"></i></a></li><li class="prev disabled"><a href="#" title="'+n.sPrevious+'"><i class="fa fa-angle-left"></i></a></li><li class="next disabled"><a href="#" title="'+n.sNext+'"><i class="fa fa-angle-right"></i></a></li><li class="next disabled"><a href="#" title="'+n.sLast+'"><i class="fa fa-angle-double-right"></i></a></li></ul>');var s=a("a",i);a(s[0]).bind("click.DT",{action:"first"},l),a(s[1]).bind("click.DT",{action:"previous"},l),a(s[2]).bind("click.DT",{action:"next"},l),a(s[3]).bind("click.DT",{action:"last"},l)},fnUpdate:function(e,i){var t,n,l,s,o,r=e.oInstance.fnPagingInfo(),g=e.aanFeatures.p,d=Math.floor(2.5);for(r.iTotalPages<5?(s=1,o=r.iTotalPages):r.iPage<=d?(s=1,o=5):r.iPage>=r.iTotalPages-d?(s=r.iTotalPages-5+1,o=r.iTotalPages):o=(s=r.iPage-d+1)+5-1,t=0,iLen=g.length;t<iLen;t++){for(r.iTotalPages<=0?a(".pagination",g[t]).css("visibility","hidden"):a(".pagination",g[t]).css("visibility","visible"),a("li:gt(1)",g[t]).filter(":not(.next)").remove(),n=s;n<=o;n++)l=n==r.iPage+1?'class="active"':"",a("<li "+l+'><a href="#">'+n+"</a></li>").insertBefore(a("li.next:first",g[t])[0]).bind("click",function(t){t.preventDefault(),e._iDisplayStart=(parseInt(a("a",this).text(),10)-1)*r.iLength,i(e)});0===r.iPage?a("li.prev",g[t]).addClass("disabled"):a("li.prev",g[t]).removeClass("disabled"),r.iPage===r.iTotalPages-1||0===r.iTotalPages?a("li.next",g[t]).addClass("disabled"):a("li.next",g[t]).removeClass("disabled")}}}}),a.extend(a.fn.dataTableExt.oPagination,{bootstrap_number:{fnInit:function(e,i,t){var n=e.oLanguage.oPaginate,l=function(a){a.preventDefault(),e.oApi._fnPageChange(e,a.data.action)&&t(e)};a(i).append('<ul class="pagination"><li class="prev disabled"><a href="#" title="'+n.sPrevious+'"><i class="fa fa-angle-left"></i></a></li><li class="next disabled"><a href="#" title="'+n.sNext+'"><i class="fa fa-angle-right"></i></a></li></ul>');var s=a("a",i);a(s[0]).bind("click.DT",{action:"previous"},l),a(s[1]).bind("click.DT",{action:"next"},l)},fnUpdate:function(e,i){var t,n,l,s,o,r=e.oInstance.fnPagingInfo(),g=e.aanFeatures.p,d=Math.floor(2.5);for(r.iTotalPages<5?(s=1,o=r.iTotalPages):r.iPage<=d?(s=1,o=5):r.iPage>=r.iTotalPages-d?(s=r.iTotalPages-5+1,o=r.iTotalPages):o=(s=r.iPage-d+1)+5-1,t=0,iLen=g.length;t<iLen;t++){for(r.iTotalPages<=0?a(".pagination",g[t]).css("visibility","hidden"):a(".pagination",g[t]).css("visibility","visible"),a("li:gt(0)",g[t]).filter(":not(.next)").remove(),n=s;n<=o;n++)l=n==r.iPage+1?'class="active"':"",a("<li "+l+'><a href="#">'+n+"</a></li>").insertBefore(a("li.next:first",g[t])[0]).bind("click",function(t){t.preventDefault(),e._iDisplayStart=(parseInt(a("a",this).text(),10)-1)*r.iLength,i(e)});0===r.iPage?a("li.prev",g[t]).addClass("disabled"):a("li.prev",g[t]).removeClass("disabled"),r.iPage===r.iTotalPages-1||0===r.iTotalPages?a("li.next",g[t]).addClass("disabled"):a("li.next",g[t]).removeClass("disabled")}}}}),a.extend(a.fn.dataTableExt.oPagination,{bootstrap_extended:{fnInit:function(e,i,t){var n=e.oLanguage.oPaginate,l=(e.oInstance.fnPagingInfo(),function(a){a.preventDefault(),e.oApi._fnPageChange(e,a.data.action)&&t(e)});a(i).append('<div class="pagination-panel"> '+(n.page?n.page:"")+' <a href="#" class="btn btn-sm default prev disabled"><i class="fa fa-angle-left"></i></a><input type="text" class="pagination-panel-input form-control input-sm input-inline input-mini" maxlenght="5" style="text-align:center; margin: 0 5px;"><a href="#" class="btn btn-sm default next disabled"><i class="fa fa-angle-right"></i></a> '+(n.pageOf?n.pageOf+' <span class="pagination-panel-total"></span>':"")+"</div>");var s=a("a",i);a(s[0]).bind("click.DT",{action:"previous"},l),a(s[1]).bind("click.DT",{action:"next"},l),a(".pagination-panel-input",i).bind("change.DT",function(i){var n=e.oInstance.fnPagingInfo();i.preventDefault();var l=parseInt(a(this).val());l>0&&l<=n.iTotalPages?e.oApi._fnPageChange(e,l-1)&&t(e):a(this).val(n.iPage+1)}),a(".pagination-panel-input",i).bind("keypress.DT",function(i){var n=e.oInstance.fnPagingInfo();if(13==i.which){var l=parseInt(a(this).val());l>0&&l<=e.oInstance.fnPagingInfo().iTotalPages?e.oApi._fnPageChange(e,l-1)&&t(e):a(this).val(n.iPage+1),i.preventDefault()}})},fnUpdate:function(e,i){var t,n,l,s,o,r=e.oInstance.fnPagingInfo(),g=e.aanFeatures.p,d=Math.floor(2.5);for(r.iTotalPages<5?(s=1,o=r.iTotalPages):r.iPage<=d?(s=1,o=5):r.iPage>=r.iTotalPages-d?(s=r.iTotalPages-5+1,o=r.iTotalPages):o=(s=r.iPage-d+1)+5-1,t=0,iLen=g.length;t<iLen;t++){var p=a(g[t]).parents(".dataTables_wrapper");for(r.iTotal<=0?a(".dataTables_paginate, .dataTables_length",p).hide():a(".dataTables_paginate, .dataTables_length",p).show(),r.iTotalPages<=0?a(".dataTables_paginate, .dataTables_length .seperator",p).hide():a(".dataTables_paginate, .dataTables_length .seperator",p).show(),a(".pagination-panel-total",g[t]).html(r.iTotalPages),a(".pagination-panel-input",g[t]).val(r.iPage+1),a("li:gt(1)",g[t]).filter(":not(.next)").remove(),n=s;n<=o;n++)l=n==r.iPage+1?'class="active"':"",a("<li "+l+'><a href="#">'+n+"</a></li>").insertBefore(a("li.next:first",g[t])[0]).bind("click",function(t){t.preventDefault(),e._iDisplayStart=(parseInt(a("a",this).text(),10)-1)*r.iLength,i(e)});0===r.iPage?a("a.prev",g[t]).addClass("disabled"):a("a.prev",g[t]).removeClass("disabled"),r.iPage===r.iTotalPages-1||0===r.iTotalPages?a("a.next",g[t]).addClass("disabled"):a("a.next",g[t]).removeClass("disabled")}}}});var e,i=abp.appPath+"Common/Scripts/Datatables/Translations/"+("zh-Hans"===(e=abp.localization.currentCulture).name||"zh-CN"===e.name?"Chinese (Simplified, China)":e.displayNameEnglish)+".json";a.ajax(i,{async:!1}).fail(function(){i=abp.appPath+"Common/Scripts/Datatables/Translations/English.json",console.log("Language is set to English for datatables, because "+abp.localization.currentCulture.displayNameEnglish+" is not found!")}).always(function(){a.extend(!0,a.fn.dataTable.defaults,{language:{url:i},lengthMenu:[5,10,25,50,100,250,500],pageLength:10,responsive:{details:{type:"column"}},searching:!1,pagingType:"bootstrap_full_number",dom:'rt<"bottom"ilp><"clear">',order:[]})})}}(jQuery);
!function(t){if(t.fn.dataTableExt){var n=function(n,e){var a=t("<li/>"),i=t("<a/>");return i.html("function"==typeof e.text?e.text(n):e.text),e.action&&i.click(function(a){a.preventDefault(),t(this).closest("li").hasClass("disabled")||e.action({record:n})}),i.appendTo(a),a},e=function(e,a,i){if(a.items&&a.items.length>1)return function(e,a){var i=t("<div/>").addClass("dropdown").addClass("action-button"),o=t("<button/>").html("function"==typeof a.text?a.text(e):a.text).addClass("btn btn-primary btn-sm dropdown-toggle").attr("data-toggle","dropdown").attr("aria-haspopup","true").attr("aria-expanded","false");a.cssClass&&o.addClass(a.cssClass);var l=t("<ul/>").addClass("dropdown-menu");app.isRTL()&&l.addClass("dropdown-menu-right");for(var r=0;r<a.items.length;r++){var d=a.items[r];if(!d.visible||d.visible({record:e})){var s=n(e,d);d.enabled&&!d.enabled({record:e})&&s.addClass("disabled"),s.appendTo(l)}}return l.find("li").length>0&&(l.appendTo(i),o.appendTo(i)),0===l.children().length?"":i}(e,a);if(a.element){var o=function(n,e){if(t(e.element).data(n),void 0===e.visible)return e.element;if("function"==typeof e.visible){if(e.visible())return e.element}else if(e.visible)return e.element;return""}(e,a);if(""!=o)return o.clone(!0)}return""},a=function(t,n,e){""==t&&function(t,n){t.fnSetColumnVis(n,!1,!1)}(n,e)},i=function(n,i,o,l,r){var d;if(d=n.aoColumns?n.aoColumns:n.fnSettings().aoColumns)for(var s=t(i).children("td"),f=0;f<d.length;f++){var u=d[f];if(u.rowAction){var c=e(o,u.rowAction);a(c,n,f),0===t(s[f]).find(".action-button").length&&t(s[f]).append(c)}}},o=t.fn.dataTableExt.oApi.renderRowActions;if(t.fn.dataTableExt.oApi.renderRowActions=function(t,n,e,a,l){o&&o(t,n,e,a,l),i(t,n,e)},t.fn.dataTable){var l=t.fn.dataTable.defaults.fnRowCallback;t.extend(!0,t.fn.dataTable.defaults,{fnRowCallback:function(t,n,e,a){l&&l(this,t,n,e,a),i(this,t,n)}})}}}(jQuery);
