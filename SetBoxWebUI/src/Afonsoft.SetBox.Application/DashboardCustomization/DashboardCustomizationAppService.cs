...
using Afonsoft.SetBox.DashboardCustomization.Definitions;
using Afonsoft.SetBox.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Afonsoft.SetBox.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SetBoxAppServiceBase, IDashboardCustomizationAppService
    {
