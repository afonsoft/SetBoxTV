...
using Afonsoft.SetBox.Friendships.Dto;

namespace Afonsoft.SetBox.Friendships
{
    [AbpAuthorize]
    public class FriendshipAppService : SetBoxAppServiceBase, IFriendshipAppService
    {
