...
using Afonsoft.SetBox.Migrations.Seed.Host;
...
namespace Afonsoft.SetBox.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SetBoxAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SetBoxDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(SetBoxConsts.ConnectionStringName).Value.ToString();
        }
